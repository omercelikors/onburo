...
/***/ "./resources/js/extensions/geodatasource-cr.js":
/*!*****************************************************!*\
  !*** ./resources/js/extensions/geodatasource-cr.js ***!
  \*****************************************************/
...
(function (root, factory) {
  ...
  var gdsClass = "gds-cr";
  var countryString = "Lütfen Bir Ülke Seçiniz";
  ...
  var generateCountryField = function generateCountryField(countryElement) {
  ...
  var translate = function translate(countryElement) {
    ...
    var gs_country = get.gettext("South Georgia and The South Sandwich Islands_GS_C");
    ...
    var mk_country = get.gettext("Macedonia, The Former Yugoslav Republic of_MK_C");
    ...
    var sh_country = get.gettext("Saint Helena, Ascension and Tristan Da Cunha_SH_C");
    ...
    var zw_region = ["Bulawayo_ZW", "Harare_ZW", "Manicaland_ZW", "Mashonaland Central_ZW", "Mashonaland East_ZW", "Mashonaland West_ZW", "Masvingo_ZW", "Matabeleland North_ZW", "Matabeleland South_ZW", "Midlands_ZW"]; //get total length of array
  ...
  var initialiseRegion = function initialiseRegion() {
    for (var i = 0; i < country_region.length; i++) {
      var regionData = {
        regions: []
      };
  ...
  var initialiseRegionField = function initialiseRegionField(regionElement) {
  ...
  var generateRegionField = function generateRegionField(countryElement, regionElement) {
  ...
  var setDefaultRegionValue = function setDefaultRegionValue(regionElement, data, defaultRegionSelectedValue) {
...
/***/ 3:
/*!***********************************************************!*\
  !*** multi ./resources/js/extensions/geodatasource-cr.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! F:\homestead_projects\onburo\resources\js\extensions\geodatasource-cr.js */"./resources/js/extensions/geodatasource-cr.js");
