...
<script>
    setInterval(function(){ 
        ...
        if(installment_number==""){
            ...
            document.getElementById("installment1_paid_amount").value = "";
            document.getElementById("installment2_paid_amount").value = "";
            document.getElementById("installment3_paid_amount").value = "";
            document.getElementById("installment4_paid_amount").value = "";
            document.getElementById("installment5_paid_amount").value = "";
            document.getElementById("installment6_paid_amount").value = "";
            document.getElementById("installment1_paid_amount").value = "";
