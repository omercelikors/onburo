...
<main class="container-fluid mt-3">
    <form method="post" action="{{ route('gain_payment_calculate') }}" enctype="multipart/form-data">
        @csrf
        <div class="card my-3">
                            ...
                            <div class="row my-2 d-flex justify-content-center">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <div class="gj-margin-top-10">
                                            <input id="start_date" name="start_date" autocomplete="off" value="{{ session('start_date') }}"
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <div class="gj-margin-top-10">
                                            <input id="end_date" name="end_date" autocomplete="off" value="{{ session('end_date') }}"
                                                placeholder="gg.aa.yyyy" required>
                                        </div>
                                    </div>
                                </div>
